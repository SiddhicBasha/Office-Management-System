...
public class Signpage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon("C:\\Users\\User\\Downloads\\rsz_1human-figure-icon-graphic-as-user-login-button-on-white-keyboard.jpg")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            while(r.next())
            {
                if(r.getString(8).equals(jTextField1.getText())&&r.getString(9).equals(jPasswordField1.getText()))
                {
